...
class PrivateIngredientApiTests(TestCase):
    """Test private Ingredient api can be retrieved by authorized user"""
    def setUp(self):
        self.client = APIClient()

        self.user = get_user_model().objects.create_user(
            'ingredienttes@test.com',
            'passingredient'
        )
    ...
    def test_create_ingredient_invalid(self):
        """Creating a new ingredient with an invalid payload"""
        payload = {'name': ''}
